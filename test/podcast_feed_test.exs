defmodule PodcastFeedTest do
  ...
  defp wasm_imports(opts) do
	[
	  ...
	  {:datasource, :get_episode_pub_date_utc, fn _id -> 0 end},
	  {:datasource, :get_episode_duration_seconds, fn _id -> 0 end},
	  ...
	  {:datasource, :get_episode_mp3_byte_count, fn _id -> 0 end},
  ...
  test "12,000 episodes" do
	episodes_count = 12_000
	  
	inst = Instance.run(PodcastFeed, wasm_imports(episodes_count: episodes_count))
	text_xml_func = Instance.capture(inst, String, :text_xml, 0)
	text_xml = text_xml_func.()
