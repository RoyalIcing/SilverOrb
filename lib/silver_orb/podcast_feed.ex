defmodule SilverOrb.PodcastFeed do
  use Orb
  # use SilverOrb.BumpAllocator
  use SilverOrb.StringBuilder
  use SilverOrb.XMLBuilder, as: XML
  ...
  Orb.Import.register(Datasource)
  ...
  defw text_xml(), StringBuilder do
    build! do
      ...
      XML.element(:title, Orb.Str.Slice.to_str(@title))

      XML.element(:description, Orb.Str.Slice.to_str(@description))
      XML.element(:"itunes:subtitle", Orb.Str.Slice.to_str(@description))
      XML.element(:"itunes:author", Orb.Str.Slice.to_str(@author))
      XML.element(:link, Orb.Str.Slice.to_str(@link))
      XML.element(:language, Orb.Str.Slice.to_str(@language))
